...
tf.app.flags.DEFINE_integer('max_epochs', 4, '步长')
tf.app.flags.DEFINE_string('train_local', './output/', '训练输出文件夹')
...
def add_new_last_layer(base_model, num_classes):
    ...
    fc__ = BatchNormalization(name='bn_fc_01')(x)
    x = fc__
...
def train_model(FLAGS):
    ...
    history_tl = model.fit_generator(
        ...
        verbose=1,
        callbacks=[
            ModelCheckpoint('./output/best.h5',
